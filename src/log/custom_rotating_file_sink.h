...
public:
    custom_rotating_file_sink(filename_t base_filename,
                       std::size_t max_size,
...
inline std::shared_ptr<logger> custom_rotating_logger_mt(const std::string &logger_name,
...
template <typename Factory = spdlog::synchronous_factory>
inline std::shared_ptr<logger> custom_rotating_logger_st(const std::string &logger_name,
                                                  const filename_t &filename,
                                                  size_t max_file_size,
                                                  size_t max_files,
                                                  bool rotate_on_open = false,
