...
constexpr uint32_t DSF_Var_VarRequestEnvelope_max_cdr_typesize {1464UL};
...
constexpr uint32_t DSF_Var_PubTableVarDefine_max_cdr_typesize {1464UL};
constexpr uint32_t DSF_Var_PubTableVarDefine_max_key_cdr_typesize {0UL};


constexpr uint32_t DSF_Var_Define_max_cdr_typesize {1448UL};
