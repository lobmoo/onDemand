 ...
 * @brief 按需发布系统 - 重构版本实现(简化版)
 * @date 2026-02-04
 */

#include "on_demand_pub_v2.h"
#include <algorithm>
#include <sstream>
...
OnDemandPublisherV2::OnDemandPublisherV2()
...
bool OnDemandPublisherV2::init(const std::string& nodeName, 
...
void OnDemandPublisherV2::handleSubscribe(const std::string& nodeName,
