        ...
        TypeIdentifierPair& type_ids_CalculatorRequestType)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_CalculatorRequestType)
    {
        ...
        }
        {
            ...
            ann_custom_CalculatorRequestType.reset();
            CompleteMemberDetail detail_data = TypeObjectUtils::build_complete_member_detail(name_data, member_ann_builtin_data, ann_custom_CalculatorRequestType);
            CompleteStructMember member_data = TypeObjectUtils::build_complete_struct_member(common_data, detail_data);
            TypeObjectUtils::add_complete_struct_member(member_seq_CalculatorRequestType, member_data);
        }
        {
        ...
        TypeIdentifierPair& type_ids_CalculatorReplyType)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_CalculatorReplyType)
    {
        ...
        }
        {
            ...
            eprosima::fastcdr::optional<AppliedBuiltinMemberAnnotations> member_ann_builtin_data;
            ann_custom_CalculatorReplyType.reset();
            CompleteMemberDetail detail_data = TypeObjectUtils::build_complete_member_detail(name_data, member_ann_builtin_data, ann_custom_CalculatorReplyType);
            CompleteStructMember member_data = TypeObjectUtils::build_complete_struct_member(common_data, detail_data);
            TypeObjectUtils::add_complete_struct_member(member_seq_CalculatorReplyType, member_data);
        }
        {
            TypeIdentifierPair type_ids_timestamp;
            ReturnCode_t return_code_timestamp {eprosima::fastdds::dds::RETCODE_OK};
