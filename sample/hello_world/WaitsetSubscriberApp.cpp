    ...
    namespace examples
    {
        namespace hello_world
        {
                  ...
                  stop_(false)
            {
                ...
                reader_ =
                    subscriber_->create_datareader(topic_, reader_qos, nullptr, StatusMask::all());
                if (reader_ == nullptr) {
            ...
            void WaitsetSubscriberApp::run()
            {
                while (!is_stopped()) {
                    ...
                    ReturnCode_t ret_code = wait_set_.wait(triggered_conditions,
                                                           eprosima::fastdds::dds::c_TimeInfinite);
            ...
            bool WaitsetSubscriberApp::is_stopped() { return stop_.load(); }
