/**
 * @file DDSDataReaderQosHandler.h
 * @brief 
 ...
 * </table>
 */
#ifndef DDS_DATA_READER_QOS_HANDLER_H
#define DDS_DATA_READER_QOS_HANDLER_H

#include <fastdds/dds/subscriber/qos/DataReaderQos.hpp>

class DDSDataReaderQosHandler
{

public:
    DDSDataReaderQosHandler(/* args */);
    ~DDSDataReaderQosHandler();
...
#endif // DDS_DATA_READER_QOS_HANDLER_H
